    ...
    <SafeAreaView style={{flex:1,backgroundColor:"#FFF"}}>
      ...
      <ImageBackground style={{backgroundColor:"black",width:375,height:730,}} source={require("../../assetes/background.jpg")}>
        ...
        {/* <View style={{ flexDirection:'row',marginLeft:-30}} >
            ...
            <Text style={{fontWeight:'700',color:"#FFF",fontSize:18,textAlign:'center'}}>Password</Text>
            </View>
        </View >

        <View style={styles.form}>
         <View style={styles.headerText}>
            <Text style={{fontSize:32,color:'#212121',fontWeight:'700'}}>Password</Text>
         ...
         <View style={{flexDirection:'row'
                ...
                />
                 <Image 
                style={{height:25,width:25,marginTop:15,marginRight:10,marginLeft:80}}
